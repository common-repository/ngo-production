						...
						do_action("wally_before-post-loop-item"); if(isset($post)):
							...
							<header class="article-box__header below-figure">
								...
								if(is_user_logged_in() && current_user_can('edit_posts')):
									...
									?>
									<a href="<?= $url; ?>" class="edit-btn" title="<?php echo $post->post_type === 'production_actors' ? __('Redigera inlägg', 'wally') : __('Redigera sida', 'wally') ?>">
										<span>
							...
							<div class="article-box__content">
								...
								<!-- Show taxonomy image -->
									...
									<div class="pull-left" style="margin-right:2%;">
									<br /><strong><?php _e( 'Medverkar i:', 'wally-child-ngo' ); ?></strong><br />
